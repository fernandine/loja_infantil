...
export class CategoryFilterComponent {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      this.filterProducts(brandFilters, colorFilters, sizeFilters,  this.selectedCategory?.id);
    });
  }

  filterProducts(brandFilters: string[], colorFilters: string[], sizeFilters: string[], categoryId: number): void {
    this.productService.getProductsByFilters(brandFilters, colorFilters, sizeFilters, [{id: categoryId}] as Category[])
      .subscribe(products => {
