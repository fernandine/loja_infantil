...
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, product_color, product_brand, product_size) VALUES ('SND001', 'Sandália Feminina', 'Sandália confortável e elegante para o dia a dia', 'sandalia-feminina.jpg', false, 100, 79.99, 5, '2022-01-02', 0, 'AZUL', 'CARINHOSO', 'P');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, product_color, product_brand, product_size) VALUES ('CHN001', 'Chinelo Masculino', 'Chinelo básico para uso casual', 'chinelo-masculino.jpg', false, 150, 29.99, 5, '2022-01-03', 0, 'AMARELO', 'CARINHOSO', 'G');
...
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, product_color, product_brand, product_size) VALUES ('SPT001', 'Sapatilha Feminina', 'Sapatilha elegante para uso em ocasiões formais', 'sapatilha-feminina.jpg', false, 75, 149.99, 5, '2022-01-05', 0, 'LILÁS', 'PUC', 'M');
