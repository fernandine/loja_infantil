...
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('BOT001', 'Bota Masculina', 'Bota de couro para uso em ambientes frios', 'bota-masculina.jpg', false, 50, 299.99, 5, '2022-01-04', 0, 'AZUL', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('SPT001', 'Sapatilha Feminina', 'Sapatilha elegante para uso em ocasiões formais', 'sapatilha-feminina.jpg', false, 75, 149.99, 5, '2022-01-05', 0, 'LILÁS', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('SPT002', 'Sapato Social Masculino', 'Sapato social de couro para uso em ambientes profissionais', 'sapato-social-masculino.jpg', false, 25, 349.99, 5, '2022-01-06', 0, 'ROXO', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('CHN002', 'Chinelo de Dedo Feminino', 'Chinelo básico para uso casual', 'chinelo-de-dedo-feminino.jpg', false, 200, 19.99, 5, '2022-01-07', 0, 'VERDE', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('BOT002', 'Bota de Chuva Unissex', 'Bota impermeável para uso em dias chuvosos', 'bota-de-chuva-unissex.jpg', false, 100, 89.99, 5, '2022-01-08', 0, 'ROSA_BEBE', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('PTF001', 'Pantufa Unissex', 'Pantufa confortável para uso no inverno', 'pantufa-unissex.jpg', false, 50, 49.99, 5, '2022-01-09', 0, 'BRANCO', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('TNS002', 'Tênis Infantil com Luzinhas', 'Tênis infantil com luzinhas na sola', 'tenis-infantil-luzinhas.jpg', false, 75, 79.99, 5, '2022-01-10', 0, 'CINZA', 'PUC', 'M');
...
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('GLC001', 'Galocha Feminina', 'Galocha elegante para uso em dias chuvosos', 'galocha-feminina.jpg', true, 50, 129.99, 5, '2022-01-12', 0, 'CINZA', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('SPN001', 'Sapatênis Masculino', 'Sapatênis casual para uso no dia a dia', 'sapatênis-masculino.jpg', true, 75, 149.99, 5, '2022-01-13', 0, 'CINZA', 'PUC', 'M');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('ESP001', 'Espadrille Feminina', 'Espadrille elegante para uso em ocasiões informais', 'espadrille-feminina.jpg', false, 25, 99.99, 5, '2022-01-14', 0, 'CINZA', 'PUC', 'SIZE_4');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('MCS001', 'Mocassim Masculino', 'Mocassim de couro para uso em ambientes profissionais', 'mocassim-masculino.jpg', false, 50, 199.99, 5, '2022-01-15', 0, 'CINZA', 'PUC', 'SIZE_8');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('ALP001', 'Alpargata Feminina', 'Alpargata confortável e casual para uso no dia a dia', 'alpargata-feminina.jpg', false, 100, 59.99, 5, '2022-01-16', 0, 'VERDE', 'PUC', 'SIZE_4');
INSERT INTO product (sku, name, description, image, favorite, units_in_stock, unit_price, category_id, date_created, sales_count, color, brand, size) VALUES ('TNS004', 'Tênis de Basquete Masculino', 'Tênis de basquete com alta performance', 'tenis-basquete-masculino.jpg', false, 20, 399.99, 5, '2022-01-17', 0, 'VERDE', 'PUC', 'SIZE_4');
